...
?>
        <script>
            ...
            Swal.fire({
                ...
                let namaGudangInput = document.getElementById('namaGudang');
                namaGudangInput.focus();
                namaGudangInput.setSelectionRange(namaGudangInput.value.length, namaGudangInput.value.length);
            });
        </script>
<?php
